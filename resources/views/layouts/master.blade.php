                    ...
                    <div class="container-fluid p-0">
                        ...
                        <div class="dropdown d-none d-sm-flex border-right navbar-border navbar-height align-items-center">
                            ...
                            <div id="demos" class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="app-projects.html">Projects</a>
                                <a class="dropdown-item" href="student-dashboard.html">Learning</a>
                                <a class="dropdown-item" href="social-activity.html">Social</a>
                            </div>
                        </div>
                        ...
                        <form class="search-form d-none d-xl-flex flex mr-3" action="index.html">
