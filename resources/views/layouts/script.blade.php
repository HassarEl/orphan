    ...
    <!-- App -->
    <script src="{{ URL::asset('assets/js/toggle-check-all.js')}}"></script>
    <script src="{{ URL::asset('assets/js/check-selected-row.js')}}"></script>
    <script src="{{ URL::asset('assets/js/dropdown.js')}}"></script>
    <script src="{{ URL::asset('assets/js/sidebar-mini.js')}}"></script>
    ...
    <!-- Chart Samples -->
    <script src="{{ URL::asset('assets/js/page.dashboard.js')}}"></script>
